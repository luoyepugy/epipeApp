        ...
        return {
            ...
            check: function() {
                ...
                if (typeof IonicDeploy != "undefined") {
                    IonicDeploy.check($ionicApp.getApp().app_id, $ionicApp.getApp().channel_tag,
                        $ionicApp.getApp().domain,
                        function(result) {
            ...
            download: function() {
                ...
                if (typeof IonicDeploy != "undefined") {
                    IonicDeploy.download($ionicApp.getApp().app_id, $ionicApp.getApp().domain,
                        function(result) {
            ...
            update: function() {
                ...
                if (typeof IonicDeploy != "undefined") {
                    ...
                    IonicDeploy.check($ionicApp.getApp().app_id, $ionicApp.getApp().channel_tag,
                        $ionicApp.getApp().domain,
                        function(result) {
                            if (result.available == 'true' && result.compatible == 'true') {
                                ...
                                // There are no updates, redirect
                                 deferred.reject("Unable: available or compatible is false");
                                //IonicDeploy.redirect($ionicApp.getApp().app_id);
                            }
                        },
                        function(error) {
